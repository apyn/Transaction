  ...
  data.forEach((element) => {
    ...
    result += `
         <ol class="table-item">
                ...
                <button id="open-modal" class="mobile-mode-btn-open hidden" data-open-btn-id=${
                  element.refId
                }>جذئیات بیشتر</button>
              </ol>
               <ol class="table-item-mobile hidden" data-modal-id=${
                 element.refId
               }>
                 <li>${numberFormatterToPersian(data.indexOf(element) + 1)}</li>
                 <li>${element.type}</li>
                 ...
                 <button class="mobile-mode-btn-close" id=${
                   element.refId
                 } data-close-btn-id=${element.refId}>بستن</button>
               </ol>`;
